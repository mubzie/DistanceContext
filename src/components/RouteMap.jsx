...
export function RouteMap({ route }) {
  ...
  return (
    <section className="rounded-[2rem] bg-white p-4 shadow-soft ring-1 ring-slate-200/80">
      ...
      <div className="overflow-hidden rounded-[1.5rem]">
        <MapContainer center={route.startCoords} zoom={13} scrollWheelZoom={false}>
          ...
          <Polyline positions={[route.startCoords, route.endCoords]} pathOptions={{ color: '#0f172a', weight: 4 }} />
        </MapContainer>
      </div>
    </section>
  );
